...
CameraControl.prototype = {
    ...
    onMouseWheel : function( e )
    {
        ...
        if( this.wheelDelta > 20 ) this.wheelDelta = 20;
    ...
    onMouseMove : function( e )
    {
        ...
        this.vector.set( ( e.pageX / window.innerWidth ) * 2 - 1, - ( e.pageY / window.innerHeight ) * 2 + 1, 0.5 ); // z = 0.5 important!
